...
extern "C"
{
    ...
    MoveID NEW_PROTECT_COUNTER_MOVES[7] = {
    ...
    // int HandlerHowlIncreaseStats(int a1, ServerFlow *a2, unsigned int a3, int a4)
    // {
    //     int result;                 // r0
    //     __int16 v7;                 // r0
    //     unsigned int i;             // r4
    ...
    // void PersonalHandlerGrudgeReady(int a1, ServerFlow *a2, int a3)
    // {
    //     HandlerParam_Message *v8; // r4
    //     if (a3 == BattleEventVar_GetValue(VAR_ATTACKING_MON))
    //     {
    //         v8 = (HandlerParam_Message *)BattleHandler_PushWork(a2, EFFECT_MESSAGE, a3);
    //         BattleHandler_StrSetup(&v8->str, 2u, 632);
    //         BattleHandler_AddArg(&v8->str, a3);
    //         BattleHandler_PopWork(a2, v8);
    //     }
    // }

    // MOVE_TRIGGERTABLE GrudgeHandlers[] = {
    //     {EVENT_MOVE_EXECUTE_END, (MOVE_HANDLER_FUNC)PersonalHandlerGrudgeReady},
    //     {EVENT_MOVE_DAMAGE_REACTION_1, (MOVE_HANDLER_FUNC)HandlerGrudgeReducePP},
    //     {EVENT_ACTION_PROCESSING_START, (MOVE_HANDLER_FUNC)HandlerDestinyBondStart},
    // };
    // int a = 0x374;
    // MOVE_TRIGGERTABLE *THUMB_BRANCH_EventAddGrudge(_DWORD *a1)
    // {
    //     *a1 = 3;
    //     return GrudgeHandlers;
    // }
    ...
    {
        int result; // r0
        // BattleMon *attacker;  // r5
        // unsigned __int8 Value; // r0
        // BattleMon *defender;         // r4
        // int v9;                // r5
        ...
        //     Value = BattleEventVar_GetValue(VAR_DEFENDING_MON);
        //     defender = Handler_GetBattleMon(a2, Value);
        //     v9 = BattleMon_GetValue(attacker, VALUE_SEX);
        //     result = BattleMon_GetValue(defender, VALUE_SEX);
        //     if (v9 == 2 || result == 2 || v9 == result)
        //     {
