...
struct	SWAN_ALIGNED(4) BattleParty  { 
    BattleMon *mons[6];u8 memberCount;u8 numCoverPos;char field_1A;char field_1B;};
...
struct	SWAN_ALIGNED(4)HandlerParam_ChangeType	 {HandlerParam_Header header;u16 nextType;u8 monID;u8 pad;};
